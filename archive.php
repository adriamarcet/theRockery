...
<?php Starkers_Utilities::get_template_parts( array( 'parts/shared/menu__combined' ) ); ?>

<?php if ( have_posts() ): ?>
	<h2 class="title__category"><?php single_cat_title( $prefix = 'Todas las recetas con la etiqueta ', $display = true ); ?></h2>
